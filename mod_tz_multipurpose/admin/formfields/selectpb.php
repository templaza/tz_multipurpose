...
class JFormFieldSelectpb extends JFormField {

    protected $type = 'Selectpb';
    ...
    public function getInput() {
        ...
        $items = $db -> loadObjectList();
        $html  = '';
        $html .= '<select multiple="" name="jform[params][selectpb]" id="jform_params_selectpb" style="display: none;" class="chzn-done">';
        $html .= '<optgroup label="---Group Field---" id="jform_params_selectpb__">';
        ...
        $html .= '<input type="hidden" value="" id="selectpb_hidden" name="'.$this->name.'"/>';
        return $html;
    }
}