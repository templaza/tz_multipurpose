...
?>
<?php if(COM_TZ_MULTIPURPOSE_JVERSION_COMPARE): //If the joomla's version is 3.0 ?>
...
<form id="adminForm" name="adminForm" method="post" action="index.php?option=com_tz_multipurpose&view=fields">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" title="<?php echo JText::_('COM_TZ_MULTIPURPOSE_FIELDS_SEARCH_DESC');?>"
                           value="<?php echo $this -> state -> filter_search;?>"
                           placeholder="<?php echo JText::_('COM_TZ_MULTIPURPOSE_SEARCH_IN_TITLE'); ?>"
                           id="filter_search"
                           name="filter_search"/>
                </div>
                ...
                <?php if(!COM_TZ_MULTIPURPOSE_JVERSION_COMPARE):?>
            ...
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th><?php echo JHTML::_('grid.sort','COM_TZ_MULTIPURPOSE_HEADING_TITLE','f.title',$this -> state -> filter_order_Dir,$this -> state -> filter_order);?></th>
                    <th width="20%"><?php echo JHTML::_('grid.sort','COM_TZ_MULTIPURPOSE_HEADING_GROUP','x.groupid',$this -> state -> filter_order_Dir,$this -> state -> filter_order);?></th>
                    <th width="10%"><?php echo JHTML::_('grid.sort','COM_TZ_MULTIPURPOSE_HEADING_TYPE','f.type',$this -> state -> filter_order_Dir,$this -> state -> filter_order);?></th>
                    ...
                    foreach($this -> items as $i => $item):
                        ...
                        <i class="icon-menu"></i>
                            ...
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    <a href="index.php?option=com_tz_multipurpose&task=field.edit&id=<?php echo $item -> id;?>">
                                        <?php echo $item -> title;?>
                                    </a>
                                </div>
                                <div class="pull-left">
