...
tzMULTIPURPOSEimport ('lessphp/lessc.inc') ;
tzMULTIPURPOSEimport ('minify/csscompressor');
...
class TZLess extends lessc
{
    ...
    public static function compileAll ($params=null,$theme = null) {
        ...
        $files = array ();
        $lesspath = 'components'.DIRECTORY_SEPARATOR.COM_TZ_MULTIPURPOSE.DIRECTORY_SEPARATOR.'less'.DIRECTORY_SEPARATOR;
        $csspath = 'components'.DIRECTORY_SEPARATOR.COM_TZ_MULTIPURPOSE.DIRECTORY_SEPARATOR.'css'.DIRECTORY_SEPARATOR;
